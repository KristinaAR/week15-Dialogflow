...
app.get('/', (req, res)=> {
    let url = 'https://api.themoviedb.org/3/movie/845781?api_key=533f0d499644fb099ce7d287fb7a2553';
    axios.get(url)
    .then(response => {
...
app.post('/search', (reg, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=533f0d499644fb099ce7d287fb7a2553&query=${userMovieTitle}`;
    let genresUrl= 'https://api.themoviedb.org/3/genre/movie/list?api_key=533f0d499644fb099ce7d287fb7a2553&language=en-US';
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`http://www.omdbapi.com/?t=${movieToSearch}&apikey=2d1f8617`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
